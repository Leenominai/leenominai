...
- ambassador_onboarding - Командный проект для компании Яндекс: создание телеграм-бота с использованием Aiogram, SQLAlchemy и asyncio, интеграцией Telegram и Google API для управления взаимодействием менеджера платформы обучения с пользователями (амбассадорами системы Яндекса). Закрытый исходный код.
