...
- ambassador_onboarding - Командный проект для компании Яндекс: создание телеграм-бота с использованием Aiogram, SQLAlchemy и интеграцией Telegram и Google API для управления взаимодействием менеджера системы обучения с пользователями (амбассадорами Яндекса). Закрытый исходный код.
